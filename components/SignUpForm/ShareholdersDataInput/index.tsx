...
const ShareholdersDataInput: React.FC<StepProps> = ({ dispatch, dispatchType, defValue }) => {
    ...
    return (
         <div className={style.Component}>
             <div className={style.Header}>
                <h2>Add shareholder data</h2>
            </div>
            { !error && <label>Shareholders data</label> }
...
export default ShareholdersDataInput
