...
const ShareholdersInput: React.FC<StepProps> = ({ dispatch, dispatchType, defValue }) => {
    ...
    return (
         <div className={style.Component}>
             <div className={style.Header}>
                <h2>Add shareholders</h2>
            </div>
            { !error && <label>Shareholder</label> }
...
export default ShareholdersInput
